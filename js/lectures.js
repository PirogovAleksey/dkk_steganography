const lectures = [
  {
    ...
    topics: [
      ...
      { title: "Сучасні застосування", desc: "Законні та зловмисні застосування, інструменти, правові аспекти стеганографії" },
      { title: "Вступ до стегоаналізу", desc: "Визначення, класифікація стегоаналітичних методів, сучасний стан" },
      { title: "Контрольні запитання", desc: "Питання для перевірки розуміння матеріалу лекції" }
    ],
    ...
    presentations: [
      ...
      { title: "Тема 1.5 — Сучасні застосування", desc: "Інструменти, правові аспекти, загрози", url: "slides/1-1/tema5.html" },
      { title: "Тема 1.6 — Вступ до стегоаналізу", desc: "Визначення, класифікація, еволюція", url: "slides/1-1/tema6.html" },
      { title: "Тема 1.7 — Контрольні запитання", desc: "Перевірка розуміння матеріалу", url: "slides/1-1/tema7.html" }
    ]
  },
  {
    id: 2,
